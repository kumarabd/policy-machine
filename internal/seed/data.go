...
func GetSeedData(tenantID string) *SeedData {
	...
	return &SeedData{
		...
		Objects: []postgres.Object{
			{ID: objDocPRD, TenantID: tenantID, ExternalID: "doc/prd-customer-portal", AttributeType: "document", CreatedAt: now.Add(-120 * 24 * time.Hour)},
			{ID: objDocAPI, TenantID: tenantID, ExternalID: "doc/api-design-v3", AttributeType: "document", CreatedAt: now.Add(-45 * 24 * time.Hour)},
			{ID: objProjectPortal, TenantID: tenantID, ExternalID: "project/customer-portal-redesign", AttributeType: "project", CreatedAt: now.Add(-60 * 24 * time.Hour)},
			{ID: objRepoEngine, TenantID: tenantID, ExternalID: "repo/policy-engine", AttributeType: "repository", CreatedAt: now.Add(-730 * 24 * time.Hour)},
			{ID: objSecretDB, TenantID: tenantID, ExternalID: "secret/db-prod-credentials", AttributeType: "secret", CreatedAt: now.Add(-365 * 24 * time.Hour)},
			{ID: objAPIManagement, TenantID: tenantID, ExternalID: "api/subject-management-v2", AttributeType: "api", CreatedAt: now.Add(-180 * 24 * time.Hour)},
			{ID: objRepoFrontend, TenantID: tenantID, ExternalID: "repo/frontend-app", AttributeType: "repository", CreatedAt: now.Add(-450 * 24 * time.Hour)},
			{ID: objSecretAWS, TenantID: tenantID, ExternalID: "secret/aws-access-key-prod", AttributeType: "secret", CreatedAt: now.Add(-200 * 24 * time.Hour)},
			{ID: objAPIAnalytics, TenantID: tenantID, ExternalID: "api/analytics-v1", AttributeType: "api", CreatedAt: now.Add(-300 * 24 * time.Hour)},
			{ID: objDocSecurity, TenantID: tenantID, ExternalID: "doc/security-policy", AttributeType: "document", CreatedAt: now.Add(-180 * 24 * time.Hour)},
		},
		ObjectSets: []postgres.ObjectAttribute{
