    ...
    "definitions": {
        ...
        "server.AuthorizationRequest": {
            ...
            "properties": {
                ...
                "subject": {
                    "description": "Subject performing the action (user, service, etc.)\nrequired: true\nexample: user123",
                    "type": "string"
                }
            }
        },
        "server.AuthorizationResponse": {
            ...
            "properties": {
                ...
                "policy_id": {
                    "description": "Policy that made the decision (optional)\nexample: rbac-admin-policy",
                    "type": "string"
                },
                "reason": {
        ...
        "server.CreateRoleRequest": {
            ...
            "properties": {
                ...
                "properties": {
                    "description": "Additional properties for the role\nexample: {\"department\": \"IT\", \"level\": \"high\"}",
                    "type": "object",
